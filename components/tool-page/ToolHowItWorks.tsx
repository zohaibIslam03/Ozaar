...
import type { Step } from "@/lib/toolConfig";
...
export default function ToolHowItWorks({ steps, accentColor }: ToolHowItWorksProps) {
  return (
    <section id="how-it-works" className="w-full bg-white" style={{ padding: "100px 0" }}>
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div
            ...
            style={{
              background: "repeating-linear-gradient(90deg, #E0E0E0, #E0E0E0 8px, transparent 8px, transparent 18px)",
              height: "1px",
            }}
          />
...
function StepIcon({ icon, color }: { icon: string; color: string }) {
  ...
  return (icons[icon] ?? icons.upload) as React.ReactElement;
}
